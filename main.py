...
@app_commands.describe(
    สาขา="เลือกสาขา",
    ลูกค้า="ชื่อลูกค้า",
    ใช้หมวก="ใช้หมวกหรือไม่",
    ใช้กกน="ใช้กกนหรือไม่",
    ใช้ชุดทำความสะอาด="ใช้ชุดทำความสะอาดหรือไม่",
    ใช้Milky="ใช้ Milky หรือไม่",
    ใช้ยาชา="ใช้ยาชาหรือไม่",
    ใช้แล็ปยาชา="ใช้แล็ปยาชาหรือไม่",
...
async def ส่งtrt(interaction: discord.Interaction,
    ...
    ลูกค้า: str,
    ใช้หมวก: Optional[bool] = False,
    ใช้กกน: Optional[bool] = False,
    ใช้ชุดทำความสะอาด: Optional[bool] = False,
    ใช้Milky: Optional[bool] = False,
    ใช้ยาชา: Optional[bool] = False,
    ใช้แล็ปยาชา: Optional[bool] = False,
    ...
    selected_equipment = []
    if ใช้หมวก: selected_equipment.append("TRT-หมวก")
    if ใช้กกน: selected_equipment.append("TRT-กกน")
    if ใช้ชุดทำความสะอาด: selected_equipment.append("TRT-ชุดทำความสะอาด+บำรุง")
    if ใช้Milky: selected_equipment.append("TRT-Milky ทำความสะอาด")
    if ใช้ยาชา: selected_equipment.append("TRT-ยาชา")
    if ใช้แล็ปยาชา: selected_equipment.append("แล็ปยาชาหน้ากาก")
